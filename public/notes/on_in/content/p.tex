...
\subsection{Several Theorems before Additional Theorems:}
...
\begin{align*}
	\sum_{k=1}^{p} \frac{f(a, qk)}{k} + \Bigl( \pi^{\frac{1}{12}} - \frac{\zeta(3)}{\pi} \Bigr)  - \pi &= 0,
\end{align*}
Then moving the left-hand-side $\pi$ to a right-hand-side $\pm \pi$.:
\begin{align*}
	\sum_{k=1}^{p} \frac{f(a, qk)}{k} + \Bigl( \pi^{\frac{1}{12}} - \frac{\zeta(3)}{\pi} \Bigr) &= \pm \pi.
\end{align*}
...
\begin{align*}
	\sum_{k=1}^{p} \frac{f(a, qk)}{k} + \Bigl( \pi^{\frac{1}{12}} - \frac{1}{\pi} \Bigr) &= \pm \frac{\pi}{\zeta(3)},\\
	\sum_{k=1}^{p} \frac{f(a, qk)}{k} &= \pm \frac{\pi}{\zeta(3)} - \Bigl( \pi^{\frac{1}{12}} - \frac{1}{\pi} \Bigr).
\end{align*}
\end{theorem}
\begin{remark}
...
\subsection{Expanding Definitions and Theorems:}
...
\end{remark}
% =============================================
\section{Some Topology and More:}
% =============================================
...
\lettrine[lines=1, lhang=0.1, loversize=0.2]{O}UR paper, per abstract, covered several theorems and proofs that we establish per \ref{remark:frac-zeta}, \ref{remark:sum-both}, \ref{theo-1}, \ref{theo:first-zeta}.
